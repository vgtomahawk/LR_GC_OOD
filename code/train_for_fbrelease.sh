...
#  echo "Seed ${seed}"
  ...
  #  python train.py --epochs=30 --batch_size=8  --gpu=0 --dataset="fbrelease"  --unsup  --short_circuit_main --word_vectors=vector_cache/glove.6B.100d.txt.p  --resume_snapshot=discriminativeClassifiers/oodExp3007_fbrelease_unsup_discriminativeClassifierWithGlove_shortcircuitmain_${seed}/best_snapshot.pt --lof --contamination ${contamination} --returnIntermediate --oodT=1 --infer_only --seed=${seed}  &> inference_logs/oodExp3007_fbrelease_unsup_discriminativeClassifierWithGlove_shortcircuitmain_lof_returnIntermediate_contamination=${contamination}_${seed}
  #done
...
do
  echo "Seed ${seed}"
  #python train.py --epochs=30 --batch_size=8  --gpu=2 --dataset="fbrelease"  --unsup  --short_circuit_main --word_vectors=vector_cache/glove.6B.100d.txt.p  --save_path=discriminativeClassifiers/oodExp3007_fbrelease_unsup_discriminativeClassifierWithGlove_shortcircuitmain_${seed}_rebuttal --hendrycks --oodT=1000 --seed=${seed} --super_root="/home/vgangal/OOD_Detect_NLP/" | tee discriminative_classifier_logs/oodExp3007_fbrelease_unsup_discriminativeClassifierWithGlove_shortcircuitmain_${seed}_rebuttal

  for tau in 1e4 1e5 1e6
  do
     python train.py --epochs=30 --batch_size=8  --gpu=0 --dataset="fbrelease"  --unsup  --short_circuit_main --word_vectors=vector_cache/glove.6B.100d.txt.p  --resume_snapshot=discriminativeClassifiers/oodExp3007_fbrelease_unsup_discriminativeClassifierWithGlove_shortcircuitmain_${seed}_rebuttal/best_snapshot.pt --hendrycks --oodT=${tau} --infer_only --seed=${seed} --super_root="/home/vgangal/OOD_Detect_NLP/"  | tee inference_logs/oodExp3007_fbrelease_unsup_discriminativeClassifierWithGlove_shortcircuitmain_hendrycks_oodT=${tau}_${seed}
  done
...
#
#  python train.py --epochs=30 --batch_size=8  --gpu=0 --dataset="fbrelease"  --unsup  --short_circuit_main --word_vectors=vector_cache/glove.6B.100d.txt.p  --resume_snapshot=discriminativeClassifiers/oodExp3007_fbrelease_unsup_discriminativeClassifierWithGlove_shortcircuitmain_${seed}/best_snapshot.pt --hendrycks --oodT=1 --infer_only --seed=${seed}  &> inference_logs/oodExp3007_fbrelease_unsup_discriminativeClassifierWithGlove_shortcircuitmain_hendrycks_oodT=1_${seed}
#
#  python train.py --epochs=30 --batch_size=8  --gpu=0 --dataset="fbrelease"  --unsup  --short_circuit_main --word_vectors=vector_cache/glove.6B.100d.txt.p  --resume_snapshot=discriminativeClassifiers/oodExp3007_fbrelease_unsup_discriminativeClassifierWithGlove_shortcircuitmain_${seed}/best_snapshot.pt --hendrycks --oodT=1000 --infer_only --seed=${seed}  &> inference_logs/oodExp3007_fbrelease_unsup_discriminativeClassifierWithGlove_shortcircuitmain_hendrycks_oodT=1000_${seed}
#
#  python train.py --epochs=30 --batch_size=8  --gpu=0 --dataset="fbrelease"  --unsup  --short_circuit_main --word_vectors=vector_cache/glove.6B.100d.txt.p  --resume_snapshot=discriminativeClassifiers/oodExp3007_fbrelease_unsup_discriminativeClassifierWithGlove_shortcircuitmain_${seed}/best_snapshot.pt --kldPrune --oodT=1 --infer_only --seed=${seed}  &> inference_logs/oodExp3007_fbrelease_unsup_discriminativeClassifierWithGlove_shortcircuitmain_kldPrune_${seed}
  
#python train.py --epochs=30 --batch_size=8  --gpu=0 --dataset="fbrelease"  --unsup  --short_circuit_main --word_vectors=vector_cache/glove.6B.100d.txt.p  --resume_snapshot=discriminativeClassifiers/oodExp3007_fbrelease_unsup_discriminativeClassifierWithGlove_shortcircuitmain_${seed}/best_snapshot.pt --ratioKldPrune --oodT=1 --infer_only --seed=${seed}  &> inference_logs/oodExp3007_fbrelease_unsup_discriminativeClassifierWithGlove_shortcircuitmain_ratioKldPrune_${seed}
...
#    do
#      python train.py  --epochs=15  --batch_size=8 --gpu=0 --dataset=${dname} --unsup --generative  --no-bidirectional --at_hidden  --word_vectors=vector_cache/glove.6B.100d.txt.p  --save_path=generativeClassifiersWithBackgrounds/ckpt_oodExp3007_${dname}_unsup_generative_atHidden_marginal_backLm_backInputSize=${backInputSize}_corruptBack_noiseLevel=${noiseLevel}_noiseType=uniroot_${seed} --marginal --back_lm --back_input_size=${backInputSize} --corrupt_back --noise_level=${noiseLevel} --noise_type=uniroot --oodT=1 --seed=${seed} &> generative_classifier_logs/oodExp3007_${dname}_unsup_generative_atHidden_marginal_backLm_backInputSize=${backInputSize}_corruptBack_noiseLevel=${noiseLevel}_noiseType=uniroot_${seed} 
#    done
#  done
